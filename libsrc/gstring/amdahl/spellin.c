#ident "@(#)/usr/src/cmd/spell/spellin.c	1.4.1.1 6/1/90 00:30:05 - (c) Copyright 1988, 1989, 1990 Amdahl Corporation"
...
char **argv;
{
	...
	if(atoi(argv[1]) <= 0) {
		fprintf(stderr, "spellin: arg not valid: must be greater than zero\n");
		exit(1);
	}
